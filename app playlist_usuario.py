...
from Modules.graficos_sprint_3_pl_usuario import grafico_genero1,grafico_artistas1,atributos1,graficos_extras1,comparador_genero1,comparador_artistas1,comparador_atributos1
...
def eda_app():
    ...
    if menu == "Inicio":
        ...
        with col2:
            ...
            df_canciones=predecir_genero_canciones(playlist_seleccionada, client_id, client_secret, generos)    
            ...
            if sub_menu == "Selecciona una opción":
                ...
                playlist_url2=st.text_input("Ingrese el enlace de la segunda playlist")
                playlist_ids = playlist2(playlist_url, playlist_url2)
                if len(playlist_ids) == 2:
                    ...
                    with col[0]:
                        ...
                        if playlist_id1 and playlist_id2:
                            comparador_artistas1(playlist_id1,playlist_id2)
                    ...
                    with col[1]:
                        if playlist_id1 and playlist_id2:
                            comparador_genero1(playlist_id1,playlist_id2)
                    ...
                    with st.container():
                        ...
                        if playlist_id1 and playlist_id2:
                            comparador_atributos1(playlist_id1,playlist_id2)
